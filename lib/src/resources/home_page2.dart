...
class _HomePage2State extends State<HomePage2> {
  ...
  final _product = <ShoesModel>[
    new ShoesModel(colors: [Colors.white,Colors.red],imgUrl: "1.png"),
    new ShoesModel(colors: [Colors.white,Colors.indigoAccent],imgUrl: "2.png"),
    new ShoesModel(colors: [Colors.white,Colors.limeAccent],imgUrl: "1.png"),
    new ShoesModel(colors: [Colors.white,Colors.black54],imgUrl: "3.png"),
